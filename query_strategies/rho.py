...
from .causal_bald import rho
from scipy import stats
import torch

class RhoSampling(Strategy):
    def __init__(self, X, Y, Cens,  ids, net_args, random_seed=123):
        super(RhoSampling, self).__init__(X, Y, Cens,  ids, net_args, random_seed=random_seed)
    ...
    def get_scores(self, n):
        ...
        t = (pt>0.5).float()
        scores = rho(mu_0, mu_1, t=t,  pt=pt, temperature=1.0)
