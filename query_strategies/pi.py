...
from .causal_bald import pi
from scipy import stats
import torch

class PiSampling(Strategy):
    def __init__(self, X, Y, Cens,  ids, net_args, random_seed=123):
        super(PiSampling, self).__init__(X, Y, Cens,  ids, net_args, random_seed=random_seed)
    ...
    def get_scores(self, n):
        ...
        #scores =  pi(samples[:,:,-1],samples[:,:,0], t=t,  pt=pt, temperature=1.0)

        #return scores, idxs_unlabeled
        '''  
